...
mod tests {
    ...
    fn test_array_decode() -> Result<()> {
        ...
        // assert_eq!(frame, RespArray::new([b"set", b"hello"]));
    ...
    fn test_map_decode() -> Result<()> {
        let mut buf = BytesMut::new();
        buf.extend_from_slice(b"%2\r\n+hello\r\n$5\r\nworld\r\n+foo\r\n$3\r\nbar\r\n");
        let _frame = RespMap::decode(&mut buf)?;
    ...
    fn test_extract_simple_frame_data() -> Result<()> {
        let mut buf = BytesMut::new();
        buf.extend_from_slice(b"+hello\r\n");
        let frame = SimpleString::decode(&mut buf)?;
        assert_eq!(frame, SimpleString::new(b"hello").into());
        Ok(())
    }
}
