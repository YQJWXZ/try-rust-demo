...
use super::{
    BulkString, RespArray, RespFrame, RespMap, RespNull, RespNullBulkString, SimpleError,
    SimpleString,
};
...
mod tests {
    ...
    fn test_array_decode() -> Result<()> {
        ...
        array.push(BulkString::new(b"hello".to_vec()).into());
        array.push(BulkString::new(b"world".to_vec()).into());
